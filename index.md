...
To date, I have around five years of experience in computer science, data science, cybersecurity, and software engineering. My contributions to these areas have resulted in 20+ publications in esteemed conferences and journals in machine learning and software engineering, such as the ACM Joint European Software Engineering Conference and Symposium on the Foundations of Software Engineering (ESEC/FSE), the International Conference on Learning Representations (ICLR), the IEEE Transactions on Software Engineering (TSE), the ACM Transactions on Software Engineering and Methodology (TOSEM), the ACM SIGKDD Conference on Knowledge Discovery and Data Mining (KDD), and the Conference on Uncertainty in Artificial Intelligence (UAI).
